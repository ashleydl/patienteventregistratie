...
@section('content')
    ...
    {!! Form::open(array('route' => 'incident.store','method'=>'POST')) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('injury', array('x' => 'Selecteer het soort letsel', 'Hoofdletsel' => 'Hoofdletsel',  'Gezichtsletsel' => 'Gezichtsletsel', 'Oogletsel' => 'Oogletsel', 'Nekletsel' => 'Nekletsel', 'Schouderletsel' => 'Schouderletsel', 'Rugletsel' => 'Rugletsel', 'Borstletsel' => 'Borstletsel', 'Buikletsel' => 'Buikletsel', 'Armen' => 'Armen', 'Handen' => 'Handen', 'Bovenbeen' => 'Bovenbeen', 'Knie' => 'Knie', 'Onderbeen' => 'Onderbeen', 'Enkel' => 'Enkel', 'Voet' => 'Voet', 'Onwel' => 'Onwel', 'Alcohol' => 'Alcohol', 'Drugs' => 'Drugs', 'Suikerspiegel' => 'Suikerspiegel'), 'x'); !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('abcd', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('respiration', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('avpu', array('x' => 'Selecteer...', 'yes_verbal' => 'Ja - Verbal', 'yes_pain' => 'Ja - Pain', 'yes_unresponsive' => 'Ja - Unresponsive', 'no_alert' => 'No - Alert'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('circulation', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('active_bleeding', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('variant_fast', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('medicines', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('relevant_diseases', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('taken_action', array('x' => 'Selecteer...', 'none' => 'Geen actie ondernomen', 'friendsandfamily' => 'Met vrienden/familie mee', 'bycomplaintscallgp' => 'Bij aanhoudende klachten huisarts bellen', 'firstaidorgp' => 'Huisarts/SEH bezoeken', 'ambulance' => 'Overgedragen ambulance', 'deniedtreatment' => 'Patient weigert behandeling/negeert advies'), 'x') !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('evaluate_supervisor', array('x' => 'Selecteer...', '0' => 'Nee', '1' => 'Ja'), 'x') !!}
            </div>
        </div>
